...
function PushCellsForward(pushFamTrack)
    ...
    for t=tStart:tEnd-1
        ...
        [costMatrix,bTrackedHulls,bNextHulls] = Tracker.GetCostSubmatrix(trackHulls, nextHulls);
        ...
        UI.Progressbar((t - tStart + 1)/(tEnd - tStart));
    end
...
function bAssign = assignTracks(costMatrix, trackedHulls, nextHulls, bPropForward)
    ...
    for i=1:length(matchedIdx)
        ...
        Tracker.AssignEdge(extHull, assignHull, bPropForward);
