...
gui_Singleton = 1;
gui_State = struct('gui_Name',       fullfile('+UI',mfilename), ...
...
% handles    structure with handles and user data (see GUIDATA)
global Figures
UI.TimeChange(str2double(get(handles.mitosisFrameTb,'String')));
close(handles.figure1);
...
% handles    structure with handles and user data (see GUIDATA)
global Figures
UI.TimeChange(str2double(get(handles.firstFrameTb,'String')));
close(handles.figure1);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
UI.TimeChange(str2double(get(handles.childrenTb,'String')));
close(handles.figure1);
